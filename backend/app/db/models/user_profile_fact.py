...
class UserProfileFact(Base, IdMixin, TimestampMixin):
    __tablename__ = "user_profile_facts"
    __table_args__ = (
        Index("ix_user_profile_facts_user_status", "user_id", "status"),
        Index("ix_user_profile_facts_user_space", "user_id", "space_id"),
    )
