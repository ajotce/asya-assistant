...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("briefing_enabled", sa.Boolean(), nullable=False, server_default=sa.false()),
        sa.Column("search_enabled", sa.Boolean(), nullable=False, server_default=sa.false()),
        sa.Column("memories_enabled", sa.Boolean(), nullable=False, server_default=sa.false()),
        sa.Column("evening_prompt_enabled", sa.Boolean(), nullable=False, server_default=sa.false()),
